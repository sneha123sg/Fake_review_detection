...
const DetectReview = () => {
  ...
  const generateMockAnalysis = (text) => {
    ...
    const fakePatterns = [
      ...
      {
        pattern: "AI-Generated (GPT-style)",
        likelihood: 0.68,
        description: "Consistent token patterns and artificial coherence",
      },
      {
        pattern: "Sentiment Manipulation",
        likelihood: 0.82,
        description: "Extreme positive/negative sentiment bias",
      },
      {
        pattern: "Keyword Stuffing",
        likelihood: 0.71,
        description: "Unusual keyword density and placement",
      },
      {
        pattern: "Human Fake",
        likelihood: 0.63,
        description: "Deliberate deception with human writing patterns",
      },
    ];
    ...
    const aiModels = [
      {
        name: "GPT-3.5",
        probability: 0.23,
        indicators: ["Token repetition", "Semantic coherence"],
      },
      {
        name: "GPT-4",
        probability: 0.18,
        indicators: ["Advanced reasoning", "Context awareness"],
      },
      {
        name: "Claude",
        probability: 0.15,
        indicators: ["Structured responses", "Balanced tone"],
      },
      {
        name: "PaLM",
        probability: 0.12,
        indicators: ["Technical accuracy", "Factual consistency"],
      },
      {
        name: "LLaMA",
        probability: 0.19,
        indicators: ["Natural flow", "Conversational style"],
      },
    ];

    const potentialAiModel =
